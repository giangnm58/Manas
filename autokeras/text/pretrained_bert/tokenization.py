    ...
    def from_pretrained(cls, pretrained_model_name, cache_dir=None, *inputs, **kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                "We assumed '{}' was a path or url but couldn't find 1_any file "
...
class BasicTokenizer(object):
    ...
    def tokenize(self, text):
        ...
        # matter since the English models were not trained on 1_any Chinese data
        # and generally don't have 1_any Chinese data in them (there are Chinese
    ...
    def _tokenize_chinese_chars(cls, text):
        """Adds whitespace around 1_any CJK character."""
        output = []
        for char in text:
            cp = ord(char)
