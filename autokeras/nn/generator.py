...
# class transformed_model_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape, link, trans=None):
#
#         super(transformed_model_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class transformed_model_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape, link, trans=None):
#
#         super(transformed_model_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class transformed_model_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape, link, trans=None):
#
#         super(transformed_model_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class TestMlpGenerator(NetworkGenerator):
#     """A class to generate Multi-Layer Perceptron.
#     """
#
#     def __init__(self, n_output_node, input_shape):
#         super(TestMlpGenerator, self).__init__(n_output_node, input_shape)
#         if len(self.input_shape) > 1:
#             raise ValueError('The input dimension is too high.')
#
#     def generate(self, model_len=None, model_width=None):
...
#
#         graph = Graph(self.input_shape, False)
#         print(self.input_shape, 'xxxxxxx')
#         output_node_id = 0
#         n_nodes_prev_layer = self.input_shape[0]
#         for i in range(2):
...
#
#
# # Mined default model for classification 2-10
#
# # 157
# # optimizer SGD([f,], lr=0.005)
# class model_classification_2_10_0(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_0, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 32, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.conv(32, 32, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(self.conv(32, 64, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.conv(64, 64, kernel_size=3, stride=1), output_node_id)
...
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         graph.add_layer(StubDense(256, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_0########################################
# class model_classification_2_10_0_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_0_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_0_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_0_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.1), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(32, 32, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
...
#
#
# class model_classification_2_10_0_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_0_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 16, kernel_size=5, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
...
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(StubDense(64, 512), output_node_id)
#         output_node_id = graph.add_layer(StubDense(512, 128), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.2), output_node_id)
#         graph.add_layer(StubDense(128, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_1########################################
# class model_classification_2_10_1_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_1_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_1_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_1_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_1_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_1_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
# # 362
# # optimizer SGD(, lr=0.01, momentum = .9, weight_decay=5e-4   )
# class model_classification_2_10_2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 64, kernel_size=11, stride=4), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#         output_node_id = graph.add_layer(self.conv(64, 192, kernel_size=5, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
...
#
#
# ###############################Transformed model for model_classification_2_10_2########################################
# class model_classification_2_10_2_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_2_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_2_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_2_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_2_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_2_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
# class model_classification_2_10_3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.25), output_node_id)
#         output_node_id = graph.add_layer(StubDense(128, 256), output_node_id)
#         graph.add_layer(StubDense(256, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_3########################################
# class model_classification_2_10_3_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_3_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_3_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_3_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_3_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_3_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_4(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_4, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 28, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(28, 48, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(48, 64, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         output_node_id = graph.add_layer(StubFlatten(), output_node_id)
#
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(StubDense(64, 128), output_node_id)
#         graph.add_layer(StubDense(128, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_4########################################
# class model_classification_2_10_4_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_4_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_4_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_4_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_4_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_4_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_5(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_5, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 10, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(10, 16, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(16, 32, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         graph.add_layer(StubDense(32, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_5########################################
# class model_classification_2_10_5_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_5_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_5_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_5_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_5_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_5_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
# # 2251
# # optim.SGD(lr=0.1, momentum=0.9, weight_decay=5e-4)
# class model_classification_2_10_6(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_6, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# ###############################Transformed model for model_classification_2_10_6########################################
# class model_classification_2_10_6_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_6_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_6_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_6_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_6_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_6_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
# # optim.SGD(lr=0.1, momentum=0.9, weight_decay=5e-4)
# class model_classification_2_10_7(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_7, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         temp_input_channel = self.input_shape[-1]
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 64, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
...
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(256, 512, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(512, 512, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#
...
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(StubDense(512, 512), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.1), output_node_id)
#         graph.add_layer(StubDense(512, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_7########################################
# class model_classification_2_10_7_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_7_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_7_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_7_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_7_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_7_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
# # 5470
# # optim.SGD(lr=0.1, momentum=0.9, weight_decay=5e-4)
# class model_classification_2_10_8(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_8, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
# ###############################Transformed model for model_classification_2_10_7########################################
# class model_classification_2_10_8_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_8_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_8_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_8_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_8_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_8_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# ###############################Transformed model for model_classification_2_10_8########################################
#
# class model_classification_2_10_9(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_9, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         temp_input_channel = self.input_shape[-1]
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 96, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.conv(96, 96, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.conv(96, 96, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
...
#         output_node_id = graph.add_layer(self.dropout(0.5), output_node_id)
#
#         output_node_id = graph.add_layer(self.conv(96, 192, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.conv(192, 192, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.conv(192, 192, kernel_size=3, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
...
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#
#         graph.add_layer(StubDense(192, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_9########################################
# class model_classification_2_10_9_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_9_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_9_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_9_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_9_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_9_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_10(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_10, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         temp_input_channel = self.input_shape[-1]
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 32, kernel_size=7, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.batch_norm(graph.node_list[output_node_id].shape[-1]), output_node_id)
#         output_node_id = graph.add_layer(StubReLU(), output_node_id)
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.15), output_node_id)
...
#         output_node_id = graph.add_layer(StubDense(128, 1000), output_node_id)
#         output_node_id = graph.add_layer(StubSoftmax(), output_node_id)
#         graph.add_layer(StubDense(1000, self.n_output_node), output_node_id)
#         return graph
#
#
# ###############################Transformed model for model_classification_2_10_10########################################
# class model_classification_2_10_10_ver1(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_10_ver1, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_10_ver2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_10_ver2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_10_ver3(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_10_ver3, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#
#
# class model_classification_2_10_11(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_11, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 64, kernel_size=5, stride=2), output_node_id)
#         output_node_id = graph.add_layer(self.conv(64, 64, kernel_size=5, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#
#         output_node_id = graph.add_layer(self.dropout(0.25), output_node_id)
#         output_node_id = graph.add_layer(StubDense(64, 128), output_node_id)
...
#
# # slow
# class model2(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model2, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 64, kernel_size=8, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.2), output_node_id)
#         output_node_id = graph.add_layer(self.conv(64, 128, kernel_size=6, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.conv(128, 128, kernel_size=5, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.dropout(0.5), output_node_id)
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#
#         graph.add_layer(StubDense(128, self.n_output_node), output_node_id)
...
#
#
# class model_classification_2_10_12(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_12, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         output_node_id = graph.add_layer(self.pooling(), output_node_id)
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         output_node_id = graph.add_layer(StubDense(64, 200), output_node_id)
#         graph.add_layer(StubDense(200, self.n_output_node), output_node_id)
#         return graph
#
#
# # 1072
# # optim.SGD(lr=0.1, momentum=0.9, weight_decay=5e-4)
# class model_classification_2_10_13(NetworkGenerator):
#
#     def __init__(self, n_output_node, input_shape):
#
#         super(model_classification_2_10_13, self).__init__(n_output_node, input_shape)
#         self.n_dim = len(self.input_shape) - 1
#         if len(self.input_shape) > 4:
#             raise ValueError('The input dimension is too high.')
#         if len(self.input_shape) < 2:
...
#         graph = Graph(self.input_shape, False)
#         output_node_id = 0
#         output_node_id = graph.add_layer(self.conv(self.input_shape[-1], 6, kernel_size=5, stride=4), output_node_id)
#         output_node_id = graph.add_layer(self.conv(6, 16, kernel_size=5, stride=1), output_node_id)
#         output_node_id = graph.add_layer(self.global_avg_pooling(), output_node_id)
#         output_node_id = graph.add_layer(StubDense(16, 120), output_node_id)
#         output_node_id = graph.add_layer(StubDense(120, 84), output_node_id)
#         graph.add_layer(StubDense(84, self.n_output_node), output_node_id)
#         return graph
