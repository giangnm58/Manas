...
class ModelTrainer(ModelTrainerBase):
    ...
    def train_model(self,
        ...
        print(optim, lr, momentum, weight_decay, 'xxxxxxxxxxxxxxxxxxxxxx')

        '''
        self.optimizer = torch.optim.SGDtorch.optim.SGD(
            self.model.parameters(),
            lr=0.1,
            momentum=0.9)
        '''
        ...
        print(sum(test_loss_list[-last_num:]) / last_num,
